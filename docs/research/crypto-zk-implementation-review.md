...
| --- | --- | --- |
| E1 | Chain integration: `482c5b9e02bec0adc70797eade0a67f60baf2619` | `runtime/src/lib.rs`; `primitives/dilithium-crypto/src/{types,scheme_macro,traits}.rs`; `pallets/wormhole/src/lib.rs`; `Cargo.toml` |
| E2 | Signature library: `3b1464f751d536aba023a53df2a4f4533ab94f62` | `dilithium/src/{ml_dsa_65,ml_dsa_87,params}.rs`; `dilithium/Cargo.toml`; `dilithium/LICENSE` |
| E3 | Hash implementation: `0117e2ca7f46a07d86a43385b5079ac6aaadaadc` | `src/{lib,poseidon2,serialization}.rs`; `Cargo.toml` |
| E4 | Specialized circuits: `e77ba5c70da7dc7b3d3da82c84e0fb8e20b40c99` | `common/src/circuit.rs`; `wormhole/circuit/src/circuit.rs`; `ownership/circuit/src/circuit.rs`; `wormhole/aggregator/src/`; `LICENSE` |
| E5 | Recursive proof engine: `6d2ccc298368e11df34a9211b72424a655bcd799` | `core/src/circuit_config.rs`; `plonky2/src/`; `Cargo.toml` |
| E6 | Peer identity: `b9a7f46426efa2cf9b2ba20b95851ca18f361c95` | `src/keypair.rs` |
| E7 | Transport: `901f09f30b32f910395270bba3a566191dc2f61f` | `src/protocol.rs` |

These identifiers preserve the inspected revision and code locations; library names in descriptive text are algorithm/framework names, not a claim of original authorship. Exact provenance and applicable notices must accompany any later dependency import.
